...
export function workerServiceSlugs(worker = {}) {
  const source = worker || {};
  const raw = [
    ...splitServiceValues(source.skills),
    ...splitServiceValues(source.main_skill),
    ...splitServiceValues(source.service_type),
    ...splitServiceValues(source.skill_slug),
    ...splitServiceValues(source.category),
  ];
